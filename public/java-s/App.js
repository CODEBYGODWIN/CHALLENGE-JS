...
const App = (function(itemCtrl, UICtrl){
    ...
    //changer la sous-catégorie et obtenir la catégorie sélectionnée, puis mettre à jour les options de sous-catégorie
    ...
    const saveDataLocally = function(){
        ...
        const save = localStorage.getItem(`budgetData-${userEmail}`);
        console.log(save);
    };
